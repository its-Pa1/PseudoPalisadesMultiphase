function [x,y,c_total,m_total,n_total,h_total] = compute_three_occ_chi_double()
clear all;
clc;
close all;
...
% and save the involved variables
% in this case chi = 10; double of base case (Experiment 4.3 of the thesis (model 4.4.39))
